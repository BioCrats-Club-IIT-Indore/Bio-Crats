  ...
  const coreTeam = [
    {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBUoN5qjLH5NEEQ4vztbsAURdLQifIFCyK4B5WJGJIb-CGDD_nzjTVKLXAWovIPr94846-ofgoHBETX_f2YAU8IOqKyJLqRcHY9wjx5wEBc22s4ROaJ5tKTyAwt78NHZiY517thLNItTVN4l0ju5GbzX6Vx1BRpdryXFG9nYJE4oRka9s9mQNGVtbOgj1zfsYYblLmLh9-cFHmJ_jK0Gt2oEYAf1n2SY_L4fldya081B5xapwLmFOy6fklqlbghjt31Y5x4lqLrEczw",
    },
    {
      name: "Dr. Rohan Verma",
      role: "Faculty Co-Advisor",
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBsgv8Jo4R5uFKbmQJVmwblhHI1_P6-iSzycd-Zq-DcIwU4w0DU9RKEgpRfdv1LaVQ2awFuuOEQS9r5ie870MgitpYL8GJ1NIbRJvU_5AHRboWTc4Jo3028MOKIho3dCAv0NYcSljjfcQLQQ6vpnb8JvzzhpbiA4AYMvJNwz-Kni0Skq1FfYimCac9jRf0AZQ8C8SYw3uFIUbjHiuswI6P74MCZxtUYM6Tx2hohoSSsGnISG9yreYp8COcxWj4BNgOf6-MKrqPWSKgv",
    },
    {
      name: "Dr. Priya Kapoor",
      role: "Faculty Co-Advisor",
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuC9VgPJOx69XzKHXbzmpkT1FHJnboMUEzK0H1fjm8PRu_SpZpY-p4o2Yb4SKFerbR_XhG1srGKuHLCBvohs5xFCUrhqymA_Xi8_R5zXQKQgpJCF9Jbxhu3Fe2q8fPQffFo2yJPCVl-Sqye3ZOmk4JYuUNzalOhRXJ_fQSmcJlCjgSVYts1SSTHdxMLetblh29suQ32W0Ag1iXwCaH2jIzDmPgJXZk8J238t1WcE7BjYq68vMtCqCUnJ-t5IIt0y0Lrgv3aIMIYmjjgq",
    },
  ];
  ...
  const coordinators = [
    {
      ...
      category: "leadership",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDLXX2IFj5JB4cISuJ12gQLA-au1RpCtSS9NUf0X2MUPVftQPB84LOBRQI1hkbfdtFLfYKUnFum8d5ovHgN3N4ANI9GBGD-eIB0ax7ACAVrpUEsyOolwCJsjpVGExKWg219au8r2hG3DzMcO0PTbCUh1WDVI0_5IOQh_6_AmzjLt_4MUaPHX97a8xxv7038SETsnLywgnHu1iZjCmU2m8TJM7QuJ2KKHoHBKKKgM0nSzaSN9XrfHpvEQ7GIk9Qqp7pEDkWB2--sQC9z",
    },
    {
      name: "Kiran Joshi",
      role: "Vice President",
      ...
      category: "leadership",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBImoZlMP7rxSftt9A9wvoTX9XJNOOB_nWTK44h_gGWp9pwjlAe7EtILSMqVLhHYzgM4br2BF3SgNzoNSiBxsvHAy1yz6pEQn-Wc8CYvaQkWfCm2j3qJgLJKRWR_yHhHdRK2nVsqWTNB8T3JVFzVNkd6WJUamzys6YLC1hsE08GTN8jxFgJX9ftPme1Qp2vuE2kYpTMkgQR9WUQyyPOuwmnH6LI5a0TYNTWlwMQDVNLhjeTzi8dvQnZDQ-UDLCL7-NKgimpauE_EIzc",
    },
    {
      name: "Riya Singh",
      role: "Secretary",
      ...
      category: "leadership",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuC5Z_fSmDo2p3VrXl9r0kUG_a4N5IphFqd-SOlRGj1i6JffyNPYvzgPlwrOkSz5P9i1cuUAR567b6L-hXAGSV-7ifQwsRgt6pbkYZUOVeQdUj6ORWhNwhPwM2N5emLFCYZgMJx-IDtkXRRH2EwhBOysFureP07u3upZ3WjIkVlQbygFN6WUqMVrm1HfTo4NIOwmRmJnjuaGo-dIZPD2oRaHlXfSpqL3fgiOm-KlARqZJYjKhoOCqAGCxZ5Imx7wvCeZ99AYwa6YQORt",
    },
    {
      name: "Vikram Mehra",
      role: "Treasurer",
      ...
      category: "leadership",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCTjjtI-akhqyb0Ft6c3LFh1mnpW66oEbVy31eRTu2IA-fqZaTTsKeV7yFB_FMuYTdHMCztEzBdn_mKd92m_0693gokQZadp3piVe0TEWpAyHIohOB3NZeAuq6DB6RPUZvJ5yb8ZmBVD5VJ6SwVv-8_I0-rY3yJg0rLN99q_sgMBgJrSRE_z9OhFTLKiziydsCwnMtLAsuyyoQniZ5xYX2Xqm0qIp-1T49tb1TxBSXeKIjJWJCSPtBaD4R3x8rJc1xm5aBvd3Uhm5L",
    },
  ];
  ...
  const executiveMembers = [
    {
      ...
      category: "events",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAnXULbLHzCNixLWSDpoR32aA7mcu5lE8LNiA1PSeim-bvV2yff4uA4VANRytS-FhJ1qH4X3EfRwFFojosVykRwc3cCokY4d92czwRLRzy5385wugri6kamtEU6i_P-QaCvaMB2w4CKL_e8FfVi5MTQwYaDtEDSI7YoRVg4r34tvyD-PbEfzW9Mpq-XPfm1Si7HHEdnZyDJNjtcRkUEa3SdbDQDB5R4W1B52YYMc5pyZ--7XdO3cROX7DP44HR3yhOLmNdnNNR9RxRR",
    },
    {
      name: "Siddharth Kapoor",
      role: "Technical Lead",
      ...
      category: "technical",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBW3wnROSAqPtjpLE-hCYYs_Ur5FOO1uqFJs3y-F2VrtPLd2GkWPwszMBuLBN2CQ_IfWgBiTlj0nPieyGn5SIPQZJW-2j2nAzIj4aaz83ARA7LebiO5BVHhPCYtP53Oo_KGdvGVHz5ZMn1diVm73JbkDz1hN8EJWP6rddc8r_Do1KKl1TzMXza4qZip-Xnz9JJXN14iDvIQRI5tFK-awbYfm0G-W4SpZkUtuEmO-a4CHcxMnkWhj0peDY-f9Mcx9hykgLdVJBO6m2R4",
    },
    {
      name: "Anika Sharma",
      role: "Outreach Coordinator",
      ...
      category: "outreach",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDme78RmAqS164kH_ti4EVmhHeYZvOIUDtsv9r0hcEFnbEyWZMXmGUk5tjXPaTE94u8NbrpXGkEL27EcLaqvO3FtyRss12KVtM1CyH06DIXGuLCE9mjjNUqF9vU1L02ZF3iu0jH_vdnNB6BzP9Pm0-k1_sbpF-LNLgfV2zM6igf4zuye1B53YiP70jYy4jPGFzanNHuD7PW98_JxHb561ETp3Oipc8sEkVE_CtVjiAshcWEnYFiduW-c5JkWkuIgenhn6zydtfTaneP",
    },
    {
      name: "Rohan Patel",
      role: "Design Head",
      ...
      category: "creative",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDAbyZTU5uZAWfpDLOleI8RBZJ0geqOTK59JEAZAqKECWoZdUyFwPgjoJSCC-MVyVcW2A2PkwBwvMhSOtcRBpjxOMnBVmQNaObJLEMAZD11hZV62tI8yTyRbfOU6Pk_rSm4Bpuoi9D7etsTNwy3yQa3LCjKRzh2OX9m01NyrLv6WjZNwBI-kQ-UkrmyE9EikonMLOQWdKGrQ7Gq8Op_8PTOjV2Kbr4SaJNmEqFBc5Pn5ynMMVNYZ6_SED-7WyHzc4UcrtIieh3QkK_5",
    },
    {
      name: "Pooja Joshi",
      role: "Content Writer",
      ...
      category: "creative",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuD3K4gwaSswV4PANeXg-v7B6_OfCl5pOsrWfi5m0xGkpWMDNRXn0T3bUI1JnuS-4n74i0k08wyY-G8ZKhMWKYTOHOl2BeF_NOupo0DkYdztz_M2LyIIutEOs86ATyy_4agt8kvcYSt7z5eVVMAK0NDhr4eDm_VAiD-A-L5FlTwbaGMHewXWCnwtlt9nohSCYuvC9Jp8C8mB4Xhrt9vprin2343vvMHyVMg_yHpI9WapGBEb1TlNAlS6rivML2mWy6hMLJdbu-0TnXBL",
    },
    {
      name: "Aryan Singh",
      role: "Social Media Manager",
      ...
      category: "creative",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAYXm4tufH4t12vtA4yj-MZiopZDICjsX-N4ie42SXzs_mdW3EsxvI4Yj9QmYRbQdlHIbQCHj_ZM688DM1bvIXF7ftfzYmXbXug_0TMhVMgqjCNvSfFr0wwj3SE10XBxiBbSDRBf-dyP31xi2Rr7LTZeTNtmkVpo7KFLqOzJGg525XtQom8UmuU1BQLiCImVKbaj_4Y-MN-l7jxgatdUmu-ql0k78GQj1dWoTrCUOnvw5M_xqdjlpcINT0DetG0mqnMDoUyUhRP4koo",
    },
  ];
  ...
  const TeamCard = ({ member, isPrimary = false, showYear = false }) => (
    <div className="group relative flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
      ...
      <div className="relative">
        ...
        {member.bio && (
          <p className="text-xs text-slate-600 mt-2 px-2 leading-relaxed">
            {member.bio}
          </p>
        )}
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-8">
              Meet the passionate minds driving innovation in biotechnology at
              IIT Indore
            </p>
