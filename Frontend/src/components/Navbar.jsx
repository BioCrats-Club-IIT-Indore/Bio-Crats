...
//                 className={`px-3 xl:px-4 py-2 rounded-lg text-lg font-medium transition-all duration-300 relative group ${
...
//             <button className="px-4 py-2 text-sm font-semibold text-slate-700 hover:text-[#1173d4] transition-colors duration-300">
//               Login
//             </button>
//             <button className="px-5 py-2 bg-slate-800 text-white text-sm font-semibold rounded-lg hover:bg-[#1173d4] transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
//               Sign Up
//             </button>
//           </div>
...
//               <button className="w-full py-2.5 text-sm font-semibold text-slate-700 border-2 border-slate-300 rounded-lg hover:border-[#1173d4] hover:text-[#1173d4] transition-all duration-300">
//                 Login
//               </button>
//               <button className="w-full py-2.5 bg-slate-800 text-white text-sm font-semibold rounded-lg hover:bg-[#1173d4] transition-all duration-300 shadow-md">
//                 Sign Up
//               </button>
//             </div>
//           </nav>
