...
import { Eye, EyeOff, Mail, Lock, User, Briefcase, GraduationCap, Calendar, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        setSubmitStatus({ type: 'success', message: data.message || 'Account created successfully!' });
